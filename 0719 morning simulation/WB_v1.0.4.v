...
always@(*)begin
	if((store_buffer_search_enanble)&&(!store_buffer_hit))begin
		...
		load_mem_rw     = 1'b1;
		load_mem_en     = (inst0_fu_select == 2'b00)? alu0_uncacheable : (inst0_fu_select == 2'b01)? alu1_uncacheable : 1'b0;
		load_uncache_en = (inst0_fu_select == 2'b00)? alu0_uncacheable : (inst0_fu_select == 2'b01)? alu1_uncacheable : 1'b0;
	end
	else begin
		load_mem_addr   = 32'b0;
		load_mem_rwen   = 4'b0;
