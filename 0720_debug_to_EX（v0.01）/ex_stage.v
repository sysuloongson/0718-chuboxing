...
/**********             uncacheable singnal                 **********/   
 ...
 always @(posedge clk) begin
  ...
  MUL_muly          = alu_in_1    [`WordDataBus_way0];//fresh
...
//ex_cp0_rw
assign  ex_cp0_rw = (ex_op[`AluOpBus_way0] == `INSN_MFC0 || ex_op[`AluOpBus_way1] == `INSN_MFC0) ? `ENABLE :`DISABLE;
